...
public class ConnectionPoolManager {
    ...
    _url = "jdbc:mysql://localhost:3306/parkinglot?serverTimezone=UTC&useUnicode=true&characterEncoding=UTF-8&useSSL=false",
    _user = "root",
    _password = "1234";
    ...
    public synchronized Connection getConnection()
        ...
        if (!initialized) {
            ...
            DriverManager.registerDriver((Driver) c.getDeclaredConstructor().newInstance());
